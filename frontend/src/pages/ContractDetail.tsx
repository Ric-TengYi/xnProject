    ...
    const items = [
        {
            ...
            children: (
                <div className="space-y-6">
                    <Card title="合同基础信息" className="glass-panel border-slate-200 dark:border-slate-700/50" extra={<Button type="link" icon={<EditOutlined />}>编辑草稿</Button>}>
                    ...
                    <Card title="资金流向" className="glass-panel border-slate-200 dark:border-slate-700/50">
                        <Row gutter={16}>
                            <Col span={8}>
                                <Card type="inner" className="bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700">
                                    <div className="text-slate-600 dark:text-slate-400 mb-2">合同总金额 (元)</div>
                                    <div className="text-2xl font-bold text-slate-900 dark:text-white">¥ {(contractInfo.amount).toLocaleString()}</div>
                                </Card>
                            </Col>
                            <Col span={8}>
                                <Card type="inner" className="bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700">
                                    <div className="text-slate-600 dark:text-slate-400 mb-2">累计已入账 (元)</div>
                                    <div className="text-2xl font-bold text-green-600 dark:text-green-400">¥ {(contractInfo.amount - contractInfo.unearned).toLocaleString()}</div>
                                </Card>
                            </Col>
                            <Col span={8}>
                                <Card type="inner" className="bg-white dark:bg-slate-800/50 border-slate-200 dark:border-slate-700">
                                    <div className="text-slate-600 dark:text-slate-400 mb-2">剩余待入账 (元)</div>
                                    <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">¥ {(contractInfo.unearned).toLocaleString()}</div>
                                </Card>
                            </Col>
                        </Row>
                    </Card>
                        ...
                        items={[
                            {
                                ...
                                children: (
                                    <div className="mb-4">
                                        <p className="text-slate-900 dark:text-white font-bold mb-1">合同发起申请</p>
                                        <p className="text-slate-600 dark:text-slate-400 text-sm">发起人: 王经办 <span className="ml-4">2024-01-08 10:00:00</span></p>
                                    </div>
                                ),
                            },
                            {
                                ...
                                children: (
                                    <div className="mb-4">
                                        <p className="text-slate-900 dark:text-white font-bold mb-1">项目部初审</p>
                                        <p className="text-slate-600 dark:text-slate-400 text-sm">审批人: 李经理 <span className="ml-4">2024-01-08 14:30:00</span></p>
                                        <div className="bg-white dark:bg-slate-800/50 p-2 rounded mt-2 text-slate-600 dark:text-slate-300 text-sm border border-slate-200 dark:border-slate-700">审批意见: 同意，单价符合标准。</div>
                                    </div>
                                ),
                            },
                            {
                                ...
                                children: (
                                    <div className="mb-4">
                                        <p className="text-slate-900 dark:text-white font-bold mb-1">财务复核</p>
                                        <p className="text-slate-600 dark:text-slate-400 text-sm">审批人: 张财务 <span className="ml-4">2024-01-09 09:15:00</span></p>
                                        <div className="bg-white dark:bg-slate-800/50 p-2 rounded mt-2 text-slate-600 dark:text-slate-300 text-sm border border-slate-200 dark:border-slate-700">审批意见: 资金预算已确认。</div>
                                    </div>
                                ),
                            },
                            {
                                ...
                                children: (
                                    <div className="mb-4">
                                        <p className="text-slate-900 dark:text-white font-bold mb-1">合同生效</p>
                                        <p className="text-slate-600 dark:text-slate-400 text-sm">系统自动流转 <span className="ml-4">2024-01-10 00:00:00</span></p>
                                    </div>
                                ),
                            }
                        ]}
        ...
        },
        {
            ...
            children: (
                <div className="space-y-6">
                    <Card title="入账记录" className="glass-panel border-slate-200 dark:border-slate-700/50" extra={<Button type="primary" size="small">新增入账</Button>}>
                        <Table
                            dataSource={[
                            ...
                            columns={[
                                ...
                                { title: '入账金额(元)', dataIndex: 'amount', key: 'amount', render: (val) => <span className="text-green-600 dark:text-green-400 font-bold">¥ {val.toLocaleString()}</span> },
                    ...
                    <Card title="发票记录" className="glass-panel border-slate-200 dark:border-slate-700/50" extra={<Button type="primary" size="small">开具发票</Button>}>
                        <Table
                            dataSource={[
                            ...
                            columns={[
                                ...
                                { title: '操作', key: 'action', render: () => <a className="text-blue-600 dark:text-blue-400">查看附件</a> },
                            ]}
                            pagination={false}
                            className="bg-transparent"
                            rowClassName="hover:bg-white dark:bg-slate-800/40 transition-colors"
                        ...
                        renderItem={item => (
                            <List.Item actions={[<a key="preview">预览</a>, <a key="download"><DownloadOutlined /> 下载</a>]}>
                                <List.Item.Meta
                                    ...
                                    description={<span className="text-slate-600 dark:text-slate-400">上传时间: {item.time}</span>}
                                />
                            </List.Item>
                        )}
                    />
    ...
    return (
        ...
        >
            <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white m-0">合同详情: {contractInfo.id}</h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">{contractInfo.project} - {contractInfo.site}</p>
                </div>
            </div>
