    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white m-0">消纳场数据看板</h1>
                    <p className="text-slate-600 dark:text-slate-400 mt-1">实时展示各消纳场地的容量使用情况与当日消纳排名</p>
                </div>
                                ...
                                >
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${index < 3 ? 'bg-gradient-to-br from-yellow-400 to-orange-500 text-slate-900 dark:text-white' : 'bg-slate-700 text-slate-600 dark:text-slate-300'}`}>
                                                    {site.rank}
                                                </div>
                                                <h3 className="text-lg font-bold text-slate-900 dark:text-white m-0 truncate" title={site.name}>{site.name}</h3>
                                            </div>
                                    ...
                                    <div className="mt-6">
                                        <div className="flex justify-between text-xs mb-1">
                                            ...
                                            <span className={isWarning ? 'text-red-600 dark:text-red-400' : 'text-blue-600 dark:text-blue-400'}>{percent}%</span>
                                        </div>
                                        <Progress
                                            percent={percent}
                                            showInfo={false}
