      ...
      <div className="mb-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-wrap gap-3 xl:justify-end">
          ...
          <MonthPicker
            ...
            placeholder="选择统计月份"
            className="w-full bg-white g-border-panel border g-text-primary sm:w-40"
          />
          <Button
            type="primary"
            icon={<DownloadOutlined />}
            className="w-full g-btn-primary border-none shadow-[0_0_15px_rgba(37,99,235,0.4)] sm:w-auto"
          >
            导出月报
          </Button>
        </div>
          ...
          <Col xs={24} sm={12} xl={6}>
            <Card className="glass-panel g-border-panel border">
              <Statistic
                ...
                styles={{ content: { color: 'var(--primary)', overflowWrap: 'anywhere' } }}
              />
          ...
          <Col xs={24} sm={12} xl={6}>
            <Card className="glass-panel g-border-panel border">
              <Statistic
                ...
                styles={{ content: { color: 'var(--success)', overflowWrap: 'anywhere' } }}
              />
          ...
          <Col xs={24} sm={12} xl={6}>
            <Card className="glass-panel g-border-panel border">
              <Statistic
                ...
                styles={{ content: { color: 'var(--warning)', overflowWrap: 'anywhere' } }}
              />
