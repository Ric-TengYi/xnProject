...
import { AlertOutlined, CarOutlined, EnvironmentOutlined, ProjectOutlined } from '@ant-design/icons';
import {
  Area,
  AreaChart,
  CartesianGrid,
...
import type { DashboardOverview, ProjectAlertItem } from '../utils/reportApi';
