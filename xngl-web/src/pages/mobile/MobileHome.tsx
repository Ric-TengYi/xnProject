...
import { CameraOutlined, CheckCircleOutlined, AlertOutlined, CarOutlined, AppstoreOutlined, ClockCircleOutlined } from '@ant-design/icons';
...
const MobileHome = () => {
  ...
  const menuItems = [
    ...
    { title: '消纳清单', path: '/mobile/disposal', icon: <CheckCircleOutlined className="text-2xl text-green-500" />, color: 'bg-green-50' },
    ...
    { title: '延期申报', path: '/mobile/delay-apply', icon: <ClockCircleOutlined className="text-2xl text-amber-500" />, color: 'bg-amber-50' }
  ];
