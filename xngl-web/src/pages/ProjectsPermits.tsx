...
const ProjectsPermits: React.FC = () => {
    ...
    const columns = [
        { title: '处置证号', dataIndex: 'id', key: 'id', render: (text: string) => <span className="font-mono g-text-secondary">{text}</span> },
        ...
        <div className="space-y-6">
            ...
            <Card className="glass-panel g-border-panel border">
                <div className="flex justify-between mb-4">
                    <Space>
                        <Input placeholder="搜索证号/项目/车牌" prefix={<SearchOutlined />} className="bg-white g-border-panel border g-text-primary w-64" />
