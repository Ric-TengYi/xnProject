        ...
        {summary ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            <div className="min-w-0">
              <div className="mb-1 text-sm g-text-secondary">项目名称</div>
              <div className="text-base font-semibold g-text-primary break-all">
                {summary.projectName || '-'}
              </div>
            </div>
            <Statistic
            ...
            <Statistic
              ...
              styles={{
                content: {
                  color: Number(summary.debtAmount || 0) > 0 ? 'var(--error)' : 'var(--success)',
